...
(function() {
  this.displayMembership = function() {
    var customer_email, customer_email_html, customer_id, customer_id_html;
    ...
    return console.log("it did reach here 2");
  };

  $(document).ready(this.displayMembership);

  $(document).on('page:load', this.displayMembership);
